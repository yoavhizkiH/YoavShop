...
Generated at: 2026-03-15T16:32:04.378130+00:00
Project: yoavshop
Milestone: 1
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/",
        "method": "GET",
        "description": "Load the home page product listing. Should return 200 with HTML containing product table.",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "home_page_search_by_product_name",
        "category": "HAPPY_PATH",
        "endpoint": "/",
        "method": "GET",
        "description": "Search products by name on the home page. Passes search_name query parameter.",
        "request_data": {
            "path": {},
            "query": {
                "search_name": "Product1"
            },
            "body": null
        },
        "expected_status": 200,
    ...
    {
        "name": "home_page_sort_by_price_descending",
        "category": "HAPPY_PATH",
        "endpoint": "/",
        "method": "GET",
        "description": "Sort products by price in descending order on the home page.",
        "request_data": {
            "path": {},
            "query": {
                "sort": "price_desc"
    ...
    {
        "name": "home_page_pagination",
        "category": "HAPPY_PATH",
        "endpoint": "/",
        "method": "GET",
        "description": "Request page 2 of the product listing. Page size is 3 items per page.",
        "request_data": {
            "path": {},
            "query": {
                "page": "2"
    ...
    {
        "name": "login_page_loads_successfully",
        "category": "HAPPY_PATH",
        "endpoint": "/accounts/login/",
        "method": "GET",
        "description": "Load the login page. Should return 200 with HTML containing a login form with username and password fields.",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "login_valid_customer_credentials",
        "category": "AUTH",
        "endpoint": "/accounts/login/",
        "method": "POST",
    ...
    {
        "name": "login_valid_supplier_credentials",
        "category": "AUTH",
        "endpoint": "/accounts/login/",
        "method": "POST",
    ...
    {
        "name": "home_page_combined_search_and_sort",
        "category": "HAPPY_PATH",
        "endpoint": "/",
        "method": "GET",
        "description": "Combine search and sort on the home page. Search by supplier name and sort by name descending.",
        "request_data": {
            "path": {},
            "query": {
