...
Generated at: 2026-03-15T16:46:05.802706+00:00
Project: yoavshop
Milestone: 2
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        "name": "category_index_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/products/categories/",
        "method": "GET",
        "description": "Retrieve the category index page with no filters - should return 200 HTML page even on empty database",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "category_index_with_search_filter",
        "category": "HAPPY_PATH",
        "endpoint": "/products/categories/",
        "method": "GET",
        "description": "Search categories by name using the searchString query parameter",
        "request_data": {
            "path": {},
            "query": {
                "searchString": "Rings"
    ...
    {
        "name": "category_index_with_sort_desc",
        "category": "HAPPY_PATH",
        "endpoint": "/products/categories/",
        "method": "GET",
        "description": "Retrieve categories sorted by name descending",
        "request_data": {
            "path": {},
            "query": {
                "sortOrder": "Name_desc"
    ...
    {
        "name": "category_index_with_pagination",
        "category": "HAPPY_PATH",
        "endpoint": "/products/categories/",
        "method": "GET",
        "description": "Retrieve the second page of categories (page size is 3)",
        "request_data": {
            "path": {},
            "query": {
                "page": "2"
    ...
    {
        "name": "category_create_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/products/categories/create/",
        "method": "POST",
        "description": "Create a new product category with a valid name - expect redirect to category index",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "category_create_form_get",
        "category": "HAPPY_PATH",
        "endpoint": "/products/categories/create/",
        "method": "GET",
        "description": "Retrieve the category creation form page",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "category_create_missing_name",
        "category": "MISSING_REQUIRED",
        "endpoint": "/products/categories/create/",
        "method": "POST",
        "description": "Attempt to create a category without providing the required name field - expect form re-render with validation errors",
        "request_data": {
            "path": {},
            "query": {},
            "body": {}
    ...
    {
        "name": "category_detail_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/products/categories/{id}/",
        "method": "GET",
        "description": "Create a category, then retrieve its detail page by ID",
        "request_data": {
            "path": {
                "id": "$setup_id"
            },
    ...
    {
        "name": "category_detail_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/products/categories/{id}/",
        "method": "GET",
        "description": "Attempt to view details for a non-existent category ID",
        "request_data": {
            "path": {
                "id": 99999
            },
    ...
    {
        "name": "category_edit_form_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/products/categories/{id}/edit/",
        "method": "GET",
        "description": "Create a category, then retrieve its edit form",
        "request_data": {
            "path": {
                "id": "$setup_id"
            },
    ...
    {
        "name": "category_edit_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/products/categories/{id}/edit/",
        "method": "POST",
        "description": "Create a category, then update its name - expect redirect to category index",
        "request_data": {
            "path": {
                "id": "$setup_id"
            },
    ...
    {
        "name": "category_edit_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/products/categories/{id}/edit/",
        "method": "GET",
        "description": "Attempt to edit a non-existent category",
        "request_data": {
            "path": {
                "id": 99999
            },
    ...
    {
        "name": "category_delete_confirm_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/products/categories/{id}/delete/",
        "method": "GET",
        "description": "Create a category, then view the delete confirmation page",
        "request_data": {
            "path": {
                "id": "$setup_id"
            },
    ...
    {
        "name": "category_delete_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/products/categories/{id}/delete/",
        "method": "POST",
        "description": "Create a category, then delete it - expect redirect to category index",
        "request_data": {
            "path": {
                "id": "$setup_id"
            },
    ...
    {
        "name": "category_delete_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/products/categories/{id}/delete/",
        "method": "GET",
        "description": "Attempt to view delete confirmation for a non-existent category",
        "request_data": {
            "path": {
                "id": 99999
            },
    ...
    {
        "name": "product_index_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/products/",
        "method": "GET",
        "description": "Retrieve the product index page with default active filter - should return 200 HTML page",
        "request_data": {
            "path": {},
            "query": {
                "active": "true"
    ...
    {
        "name": "product_index_with_name_search",
        "category": "HAPPY_PATH",
        "endpoint": "/products/",
        "method": "GET",
    ...
    {
        "name": "product_index_sort_by_price",
        "category": "HAPPY_PATH",
        "endpoint": "/products/",
        "method": "GET",
        "description": "Retrieve products sorted by price ascending",
        "request_data": {
            "path": {},
            "query": {
                "sortOrder": "Price",
    ...
    {
        "name": "product_index_inactive_filter",
        "category": "HAPPY_PATH",
        "endpoint": "/products/",
        "method": "GET",
        "description": "Retrieve only inactive (soft-deleted) products",
        "request_data": {
            "path": {},
            "query": {
                "notActive": "true"
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Attempt to view details for a non-existent product ID",
        "request_data": {
            "path": {
                "id": 99999
            },
    ...
    {
        "name": "product_create_form_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/products/create/",
        "method": "GET",
        "description": "Retrieve the product creation form with a supplier_id parameter. Requires a supplier to exist.",
        "request_data": {
            "path": {},
            "query": {
                "supplier_id": "1"
    ...
    {
        "name": "product_create_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/products/create/",
        "method": "POST",
        "description": "Create a new product with all required fields and an image file. Requires an existing supplier and category. Expect redirect on success.",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "product_create_missing_name",
        "category": "MISSING_REQUIRED",
        "endpoint": "/products/create/",
        "method": "POST",
        "description": "Attempt to create a product without the required name field - expect form re-render with validation errors",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "product_create_invalid_price_too_high",
        "category": "BOUNDARY",
        "endpoint": "/products/create/",
        "method": "POST",
        "description": "Attempt to create a product with a price exceeding the maximum (999) - expect form re-render with validation errors",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "product_create_invalid_price_zero",
        "category": "BOUNDARY",
        "endpoint": "/products/create/",
        "method": "POST",
        "description": "Attempt to create a product with price of 0 (below minimum of 1) - expect form re-render with validation errors",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "product_edit_form_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/products/{id}/edit/",
        "method": "GET",
        "description": "Attempt to retrieve edit form for a non-existent product",
        "request_data": {
            "path": {
                "id": 99999
            },
    ...
    {
        "name": "product_edit_post_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/products/{id}/edit/",
        "method": "POST",
        "description": "Attempt to submit edit form for a non-existent product",
        "request_data": {
            "path": {
                "id": 99999
            },
    ...
    {
        "name": "product_delete_confirm_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/products/{id}/delete/",
        "method": "GET",
        "description": "Attempt to view delete confirmation for a non-existent product",
        "request_data": {
            "path": {
                "id": 99999
            },
    ...
    {
        "name": "product_delete_post_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/products/{id}/delete/",
        "method": "POST",
