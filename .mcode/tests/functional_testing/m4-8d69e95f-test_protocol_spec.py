...
Generated at: 2026-03-15T17:37:20.270573+00:00
Project: yoavshop
Milestone: 4
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        "name": "login_${ADMIN_PASSWORD}_happy_path",
        "category": "AUTH",
        "endpoint": "/accounts/login/",
        "method": "POST",
        "description": "Login as ${ADMIN_PASSWORD} user with correct credentials. Expects redirect to home page (302).",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/accounts/login/",
        "method": "POST",
        "description": "Attempt login with incorrect password. Expects login form returned with error message (200).",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "login_customer_happy_path",
        "category": "AUTH",
        "endpoint": "/accounts/login/",
        "method": "POST",
        "description": "Login as Customer1 user with correct credentials. Expects redirect (302).",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "transaction_index_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/transactions/",
        "method": "GET",
        "description": "Load transaction index page without filters. Expects 200 with HTML listing transactions.",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "transaction_index_with_search",
        "category": "HAPPY_PATH",
        "endpoint": "/transactions/",
        "method": "GET",
        "description": "Search transactions by product name. Expects 200 with filtered results.",
        "request_data": {
            "path": {},
            "query": {
                "searchString": "Product1"
            },
            "body": null
        },
        "expected_status": 200,
    ...
    {
        "name": "transaction_index_sort_by_money",
        "category": "HAPPY_PATH",
        "endpoint": "/transactions/",
        "method": "GET",
        "description": "Sort transactions by money paid ascending. Expects 200 with sorted results.",
        "request_data": {
            "path": {},
            "query": {
                "sortOrder": "MoneyPaid"
    ...
    {
        "name": "transaction_index_pagination",
        "category": "HAPPY_PATH",
        "endpoint": "/transactions/",
        "method": "GET",
        "description": "Load second page of transactions (3 per page). Expects 200.",
        "request_data": {
            "path": {},
            "query": {
                "page": "2"
    ...
    {
        "name": "transaction_detail_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/transactions/{id}/",
        "method": "GET",
        "description": "Attempt to view details of a non-existent transaction. Expects 404.",
        "request_data": {
            "path": {
                "id": "99999"
            },
    ...
    {
        "name": "transaction_create_form_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/transactions/create/",
        "method": "GET",
        "description": "Load the transaction create form. Expects 200 with HTML form containing Product and Customer dropdowns.",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "transaction_create_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/transactions/create/",
        "method": "POST",
        "description": "Create a new transaction with valid data. Expects redirect to transaction index (302).",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "transaction_create_missing_required",
    ...
    {
        "name": "transaction_edit_form_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/transactions/{id}/edit/",
        "method": "GET",
        "description": "Attempt to load edit form for a non-existent transaction. Expects 404.",
        "request_data": {
            "path": {
                "id": "99999"
            },
    ...
    {
        "name": "transaction_delete_confirm_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/transactions/{id}/delete/",
        "method": "GET",
        "description": "Attempt to load delete confirmation for a non-existent transaction. Expects 404.",
        "request_data": {
            "path": {
                "id": "99999"
            },
    ...
    {
        "name": "transaction_detail_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/transactions/{id}/",
        "method": "GET",
    ...
    {
        "name": "buy_product_as_customer",
        "category": "HAPPY_PATH",
        "endpoint": "/buy/{product_id}/",
        "method": "GET",
        "description": "Purchase a product as a logged-in customer. Expects redirect to home page (302). Product stock should be decremented and a transaction created.",
        "request_data": {
            "path": {
                "product_id": "1"
            },
    ...
    {
        "name": "buy_product_unauthenticated",
        "category": "AUTH",
        "endpoint": "/buy/{product_id}/",
        "method": "GET",
        "description": "Attempt to buy a product without being logged in. Expects redirect to login page (302).",
        "request_data": {
            "path": {
                "product_id": "1"
            },
    ...
    {
        "name": "suppliers_by_transactions_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/api/suppliers-by-transactions/",
        "method": "GET",
        "description": "Retrieve supplier transaction aggregates as JSON. Returns array of {UserName, Count} objects showing total money paid per supplier.",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "transactions_by_time_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/api/transactions-by-time/",
        "method": "GET",
        "description": "Retrieve daily transaction money totals as JSON. Returns array of integers representing the sum of money paid per day.",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "transaction_index_search_no_results",
        "category": "BOUNDARY",
        "endpoint": "/transactions/",
        "method": "GET",
        "description": "Search transactions with a string that matches nothing. Expects 200 with empty results.",
        "request_data": {
            "path": {},
            "query": {
                "searchString": "zzznonexistentproduct999"
            },
            "body": null
        },
        "expected_status": 200,
    ...
    {
        "name": "transaction_index_sort_by_date_desc",
        "category": "HAPPY_PATH",
        "endpoint": "/transactions/",
        "method": "GET",
        "description": "Sort transactions by date descending. Expects 200 with sorted results.",
        "request_data": {
            "path": {},
            "query": {
                "sortOrder": "Date_desc"
    ...
    },
    {
        ...
        "endpoint": "/accounts/login/",
        "method": "GET",
        "description": "Load the login form page. Expects 200 with HTML form and CSRF token.",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
