...
Generated at: 2026-03-15T18:33:40.636855+00:00
Project: yoavshop
Milestone: 5
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        "name": "get_about_page_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/about/",
        "method": "GET",
        "description": "Verify the About page renders successfully with expected components (map container, charts, video embed)",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "get_map_locations_json_empty",
        "category": "HAPPY_PATH",
        "endpoint": "/api/map-locations/",
        "method": "GET",
        "description": "Retrieve all map locations as JSON on a fresh database (expect empty array)",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "get_map_locations_json_with_data",
        "category": "HAPPY_PATH",
        "endpoint": "/api/map-locations/",
        "method": "GET",
        "description": "Create a map location, then retrieve all locations as JSON and verify the created location is present",
        "setup": {
            "endpoint": "/locations/create/",
            "method": "POST",
            "body": {
                "place_name": "Tel Aviv Branch",
                "geo_long": 34.7818,
                "geo_lat": 32.0853,
                "info": "Open Sun-Thu 9:00-18:00"
            },
            "extract_id_from": "id"
        },
        "request_data": {
    ...
    {
        "name": "list_map_locations_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/locations/",
        "method": "GET",
        "description": "Verify the MapLocation index page renders successfully (HTML table listing)",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "get_map_location_create_form",
        "category": "HAPPY_PATH",
        "endpoint": "/locations/create/",
        "method": "GET",
        "description": "Verify the create form page renders successfully with form fields for place_name, geo_long, geo_lat, info",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "create_map_location_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/locations/create/",
        "method": "POST",
        "description": "Create a new map location with valid data, expect redirect to index on success",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
                "place_name": "Jerusalem Branch",
                "geo_long": 35.2137,
                "geo_lat": 31.7683,
                "info": "Open Sun-Thu 10:00-20:00"
            }
        },
        "expected_status": 302,
        "setup": null,
    ...
    {
        "name": "create_map_location_missing_required",
        "category": "MISSING_REQUIRED",
        "endpoint": "/locations/create/",
        "method": "POST",
        "description": "Attempt to create a map location with empty place_name, expect form re-render with validation errors (200)",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "get_map_location_detail_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/locations/{id}/",
        "method": "GET",
        "description": "Create a location, then view its detail page",
        "setup": {
            "endpoint": "/locations/create/",
            "method": "POST",
            "body": {
                "place_name": "Haifa Branch",
                "geo_long": 34.9896,
                "geo_lat": 32.794,
                "info": "Open Sun-Fri 08:00-17:00"
            },
            "extract_id_from": "id"
        },
        "request_data": {
    ...
    {
        "name": "get_map_location_detail_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/locations/{id}/",
        "method": "GET",
        "description": "Request detail for a non-existent map location ID, expect 404",
        "request_data": {
            "path": {
                "id": 99999
            },
    ...
    {
        "name": "get_map_location_edit_form_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/locations/{id}/edit/",
        "method": "GET",
        "description": "Create a location, then view its edit form pre-populated with existing data",
        "setup": {
            "endpoint": "/locations/create/",
            "method": "POST",
            "body": {
                "place_name": "Eilat Branch",
                "geo_long": 34.9519,
                "geo_lat": 29.5577,
                "info": "Open daily 09:00-22:00"
            },
            "extract_id_from": "id"
        },
        "request_data": {
    ...
    {
        "name": "get_map_location_edit_form_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/locations/{id}/edit/",
        "method": "GET",
        "description": "Request edit form for a non-existent map location, expect 404",
        "request_data": {
            "path": {
                "id": 99999
            },
    ...
    {
        "name": "update_map_location_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/locations/{id}/edit/",
        "method": "POST",
        "description": "Create a location, then update its name and info, expect redirect to index",
        "setup": {
            "endpoint": "/locations/create/",
            "method": "POST",
            "body": {
                "place_name": "Beer Sheva Branch",
                "geo_long": 34.7913,
                "geo_lat": 31.2518,
                "info": "Open Sun-Thu 09:00-17:00"
            },
            "extract_id_from": "id"
        },
        "request_data": {
            ...
            "query": {},
            "body": {
                "place_name": "Beer Sheva Central Branch",
                "geo_long": 34.7913,
                "geo_lat": 31.2518,
                "info": "Open Sun-Thu 10:00-19:00, Fri 09:00-14:00"
            }
        },
        "expected_status": 302,
        "cleanup": {
    ...
    {
        "name": "update_map_location_missing_required",
        "category": "MISSING_REQUIRED",
        "endpoint": "/locations/{id}/edit/",
        "method": "POST",
        "description": "Create a location, then attempt to update with empty place_name, expect form re-render with errors",
        "setup": {
            "endpoint": "/locations/create/",
            "method": "POST",
            "body": {
                "place_name": "Netanya Branch",
                "geo_long": 34.8573,
                "geo_lat": 32.3215,
                "info": "Open Sun-Thu 09:00-18:00"
            },
            "extract_id_from": "id"
        },
        "request_data": {
    ...
    {
        "name": "get_map_location_delete_confirmation_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/locations/{id}/delete/",
        "method": "GET",
        "description": "Create a location, then view its delete confirmation page",
        "setup": {
            "endpoint": "/locations/create/",
            "method": "POST",
            "body": {
                "place_name": "Ashdod Branch",
                "geo_long": 34.65,
                "geo_lat": 31.8,
                "info": "Open Sun-Thu 09:00-17:00"
            },
    ...
    {
        "name": "get_map_location_delete_confirmation_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/locations/{id}/delete/",
        "method": "GET",
        "description": "Request delete confirmation for a non-existent map location, expect 404",
        "request_data": {
            "path": {
                "id": 99999
            },
    ...
    {
        "name": "delete_map_location_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/locations/{id}/delete/",
        "method": "POST",
        "description": "Create a location, then delete it, expect redirect to index. No cleanup needed since the test itself deletes the resource.",
        "setup": {
            "endpoint": "/locations/create/",
            "method": "POST",
            "body": {
                "place_name": "Rishon LeZion Branch",
                "geo_long": 34.7998,
                "geo_lat": 31.973,
                "info": "Open Sun-Thu 10:00-19:00"
            },
            "extract_id_from": "id"
        },
        "request_data": {
...
HEALTH_CHECK_ENDPOINT = os.path.expandvars("/about/")
REQUEST_TIMEOUT = 30
